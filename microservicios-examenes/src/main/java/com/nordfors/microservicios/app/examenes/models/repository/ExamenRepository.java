...
public interface ExamenRepository extends PagingAndSortingRepository<Examen, Long>{
	...
	// retornar los examenes id respondidos y agrupados para que no se repita el id por cada pregunta
	// cuando p.id se encuentre dentro de la coleccion preguntasIds(where in)
